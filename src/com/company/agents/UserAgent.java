...
public class UserAgent extends GameAgent {
    ...
    public UserAgent(Board board, Player maximizerPlayer, Player minimizerPlayer) {
    ...
    public Move nextMove() {
        System.out.println(maximizerPlayer.toString()+ " move");
        ...
        switch (moveType){
            case 'm':
                ...
                move = new PawnMove(maximizerPlayer, board, row, column);
                break;
            case 'w':
                ...
                move = new WallMove(board, maximizerPlayer, row, column, wd);
                break;
        }
